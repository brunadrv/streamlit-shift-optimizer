...
def main():
    ...
    with col1:
        ...
        change_symbol = "â†—ï¸" if metrics["needed_change"] >= 0 else "â†˜ï¸"
    ...
    with col2:
        ...
        # Dynamic change indicator  
        change_symbol = "â†—ï¸" if metrics["expected_change"] >= 0 else "â†˜ï¸"
    ...
    with col3:
        ...
        change_symbol = "â†—ï¸" if gap_change >= 0 else "â†˜ï¸"
    ...
    with col4:
        ...
        change_symbol = "â†—ï¸" if punches_change >= 0 else "â†˜ï¸"
    ...
    # Employee List Filters - Compact version
    st.markdown('<div class="filter-section" style="margin-top: -10px;">', unsafe_allow_html=True)
