...
if 'data_initialized' not in st.session_state:
    ...
    # Punch rate assumptions by worker type
    punch_rates = {
        'FTE': 0.94,
        'TEMP': 0.78,
        'NEW HIRES': 0.85,
...
def main():
    ...
    with view_col2:
        ...
        view_descriptions = {
            'Roster & Expected': '📋 Planning mode: Roster, Attendance %, and Expected HC',
            'Roster & Punches': '📊 Analysis mode: Roster, Expected HC, Actual Punches, and Variance',
