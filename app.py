...
def create_combined_hc_attendance_table(filtered_hc_data, filtered_attendance_data, expected_hc_total):
    ...
    html_content += "<span class='legend-item'><span class='legend-color variance-low'></span><10% variance from last week</span>"
    html_content += "</div>"
    ...
    html_content += "<tr><th></th>"
    for _ in columns:
        html_content += "<th>Headcount</th><th>Attendance<br>Assumption</th>"
    html_content += "</tr>"
    ...
    for emp_type in employee_types:
        ...
        for shift_key in columns:
            ...
            variance_class = ''
            variance_class = random.choice(['', 'variance-low', 'variance-medium', 'variance-high'])
    ...
    # Total row
    html_content += "<tr>"
    html_content += "<td class='row-header'>Total</td>"
    ...
    for shift_key in columns:
        ...
        html_content += f"<td class='total-row'>{total_hc}</td>"
        html_content += "<td class='total-row'>-</td>"
