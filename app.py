...
if 'data_initialized' not in st.session_state:
    ...
    st.session_state.shift_summary_transposed = {
        '2026-02-12 Thu Shift 1': {
            ...
            'tooltip_expected': 'Previous Week: 24\n• FTE: 14%',
        ...
        '2026-02-12 Thu Shift 2': {
            ...
            'tooltip_expected': 'Previous Week: 23\n• FTE: 18%',
        ...
        '2026-02-12 Thu Shift 3': {
            ...
            'tooltip_expected': 'Previous Week: 16\n• FTE: 20%',
    ...
    st.session_state.attendance_assumptions_transposed = {
        '2026-02-12 Thu Shift 1': {
            'FTE Attendance Assumption': '85%',
            'TEMP Attendance Assumption': '75%',
            'NEW HIRES Show Up Rate': '50%',
            'FLEX Show Up Rate': '50%',
            'WW/GS Show Up Rate': '100%',
            'VEH Show Up Rate': '70%',
            'VER/MTO Show Up Rate': '50%',
            'tooltip_fte': 'Previous Week: 83%\n• Change: +2%',
...
def create_combined_headcount_attendance_table(filtered_hc_data, filtered_attendance_data, selected_department):
    ...
    # Department-specific multipliers removed - using direct values instead
