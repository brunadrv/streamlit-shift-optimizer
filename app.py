...
def main():
    ...
    with col2:
        ...
        # CHANGE 1: Add shift breakdown under Expected HC (simplified for stability)
        st.markdown("""
        <div style="background-color: #f8f9fa; border-radius: 6px; padding: 8px; margin-top: 8px;">
            ...
            <div style="margin-bottom: 4px; font-size: 0.75rem; color: #666;">Fri</div>
            <div style="margin-bottom: 6px;">
                <span style="background-color: #e3f2fd; color: #1565c0; padding: 2px 6px; border-radius: 12px; font-size: 0.7rem; margin: 0 2px; display: inline-block; min-width: 20px; text-align: center; font-weight: 500;">S1<br>33</span>
                <span style="background-color: #e3f2fd; color: #1565c0; padding: 2px 6px; border-radius: 12px; font-size: 0.7rem; margin: 0 2px; display: inline-block; min-width: 20px; text-align: center; font-weight: 500;">S2<br>30</span>
                <span style="background-color: #e3f2fd; color: #1565c0; padding: 2px 6px; border-radius: 12px; font-size: 0.7rem; margin: 0 2px; display: inline-block; min-width: 20px; text-align: center; font-weight: 500;">S3<br>16</span>
            </div>
        </div>
        """, unsafe_allow_html=True)
