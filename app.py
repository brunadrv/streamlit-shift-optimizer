        ...
        for date in selected_dates:
            ...
            for shift in shifts:
                ...
                if key in shift_totals:
                    ...
                    if sum_from_data > 0:
                        proportion = shift_totals[key] / sum_from_data
...
def main():
    ...
    if selected_dates and shifts:
        ...
        try:
            ...
            gap_breakdown = create_shift_breakdown_text(filtered_shift_data, selected_dates, shifts, 'Total Gap', overview_total=abs(metrics["gap"]))
