...
if 'data_initialized' not in st.session_state:
    ...
    st.session_state.weekly_hc_details_transposed = {
        ...
        '2026-02-12 Thu Shift 3': {
            ...
            'PTO': 0,
            'VER/MTO': 0,
            'tooltip_fte': 'Previous Week: 18\n• Change: +2',
            'tooltip_temp': 'Previous Week: 10\n• Change: +2',
            'tooltip_newhires': 'Previous Week: 0\n• Change: 0',
            'tooltip_flex': 'Previous Week: 0\n• Change: 0',
            'tooltip_wwgs': 'Previous Week: 0\n• Change: 0',
            'tooltip_vehmeh': 'Previous Week: 0\n• Change: 0',
...
def create_combined_headcount_attendance_table(filtered_hc_data, filtered_attendance_data):
...
def main():
    ...
    html_table = create_combined_headcount_attendance_table(filtered_hc_data, filtered_attendance_data)
